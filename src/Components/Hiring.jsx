    ...
    <div className='text-center sm:text-left p-6 md:p-0 justify-center'>
      ...
      <div className='flex flex-col md:flex-row gap-2 text-center md:text-left w-full mb-14 md:px-4 md:mb-10'>
        <div className="container md:container w-full text-left md:mx-auto md:mt-32 md:p-2">
          ...
          <div className="my-6 md:text-lg  md:my-10">
            Remotely assess a developer with take home assignments before taking interviews.
          </div>
          <div className='flex'>
        ...
        <div className='text-center md:px-2 md:flex md:w-[110%]'>
          <img src="https://uploads-ssl.webflow.com/608e9cc36cbcc089f0998643/64c5720c12a0007506d5d109_lateral-hiring-resumes-arent-enough.png" alt="assessment" className='md:mt-28 md:mb-8' />
        </div>
      </div>
      ...
      <div className='flex flex-col md:flex-row gap-2 text-center md:text-left w-full md:px-4 mb-14 md:mb-10 md:bg-gray-100'>
        ...
        <div className='text-center md:p-4 md:flex md:w-[110%] md:mt-14 md:mb-14'>
          <video autoplay preload="true" controls src="https://dersyb7nfifdf.cloudfront.net/production/32/a537b684-e7bb-4c1f-8ad8-0bb120ad9d6f.mp4"
            muted data-aos="fade-up" data-aos-offset="100" className="aos-init aos-animate" />
        ...
        <div className="container md:container w-full text-left md:mx-auto md:mt-28 md:p-2">
          ...
          <div className="my-6 md:text-lg  md:my-10">
            ...
            <ul>
              <li><img src="\icons8-dot-24.png" alt="" className='inline-block' /> Skill-based</li>
              <li><img src="\icons8-dot-24.png" alt="" className='inline-block' /> Round-based</li>
              <li><img src="\icons8-dot-24.png" alt="" className='inline-block' /> Experience-based</li>
            </ul>
          </div>
          <div className='flex'>
      ...
      <div className='flex flex-col md:flex-row gap-2 text-center md:text-left w-full md:px-4 mb-14 md:mb-10'>
        ...
        <div className='text-center md:px-2 md:flex md:w-[110%]'>
          <img src="https://uploads-ssl.webflow.com/608e9cc36cbcc089f0998643/64c675b9845988b3d1476042_lateral-hiring-powerful-proctoring-customizable-as-per-your-needs.png" alt="assessment" className='md:mt-12 md:mb-8' />
        </div>
      ...
      <div className='flex flex-col md:flex-row gap-2 text-center md:text-left w-full md:px-4 mb-14 md:mb-10 md:bg-gray-100'>
        ...
        <div className='text-center md:mt-8 md:px-2 md:flex md:w-[110%]'>
          <img src="https://uploads-ssl.webflow.com/608e9cc36cbcc089f0998643/64c5720a8bcb07f3040838c4_campus-hiring-easily-filter-top-performing-candidates.png" alt="assessment" className='md:mt-12 md:mb-8' />
        </div>
      ...
      <div className='flex flex-col md:flex-row gap-2 text-center md:text-left w-full md:px-4 mb-14 md:mb-10'>
        ...
        <div className='text-center md:px-2 md:flex md:w-[110%]'>
          <img src="https://uploads-ssl.webflow.com/608e9cc36cbcc089f0998643/64c5720b3601adf69166bf2a_campus-hiring-review-hours-long-assignments-in-minutes.png" alt="assessment" className='md:mt-12 md:mb-8' />
        </div>
      ...
      <div className='flex flex-col md:flex-row gap-2 text-center md:text-left w-full  mb-14 md:mb-10 md:bg-gray-100'>
        ...
        <div className='text-center md:px-2 md:flex md:w-[110%]'>
          <img src="https://dersyb7nfifdf.cloudfront.net/dev/2146/66e33400-e176-46a8-9e8c-de822acf6963.png" alt="assessment" className='md:mt-12 md:mb-8' />
        </div>
      ...
      <div className='flex flex-col md:flex-row gap-2 text-center md:text-left w-full md:px-4 mb-14 md:mb-10'>
        ...
        <div className='text-center md:px-2 md:flex md:w-[110%]'>
          <img src="https://dersyb7nfifdf.cloudfront.net/dev/2146/d7278f93-50ca-4be7-902b-08652ada715c.png" alt="assessment" className='md:mt-12 md:mb-8' />
        </div>
      </div>
